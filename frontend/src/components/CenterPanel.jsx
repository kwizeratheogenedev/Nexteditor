...
function CenterPanel({
  ...
  // For Editor tab: show preview + controls
  // For other tabs (media/montage, shorts, captions): show just the mode panel
  if (activeTab === 'editor') {
  ...
  // For Montage, Shorts, Captions tabs: show just the mode panel (no preview area, no controls)
