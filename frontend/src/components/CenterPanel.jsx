...
function CenterPanel({ activeTab, mediaProps, captionsProps, shortsProps, previewCurrentTime, previewDuration, previewIsPlaying, onTogglePlayback, onSeek, onFullscreen, editorProps }) {
  if (activeTab === 'editor') {
