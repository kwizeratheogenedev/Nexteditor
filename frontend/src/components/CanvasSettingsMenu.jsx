  ...
  return (
    <div
      ...
      style={{
        ...
        background: '#17171d', border: '1px solid #2a2a34', borderRadius: 10,
        boxShadow: '0 8px 28px rgba(0,0,0,.5)', padding: 14, color: '#e6e6ee',
        fontSize: 12,
      }}
    >
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
        <strong style={{ fontSize: 13 }}>Canvas settings</strong>
        <button type="button" onClick={onClose} style={{ background: 'none', border: 'none', color: '#9a99a8', cursor: 'pointer', fontSize: 14 }}>×</button>
      </div>

      <div style={{ marginBottom: 12 }}>
        <div style={{ color: '#9a99a8', marginBottom: 6 }}>Platform</div>
          ...
          {PLATFORM_PRESETS.map((preset) => (
            <button
              ...
              style={{
                ...
                border: '1px solid transparent', color: '#e6e6ee',
              }}
            >
              {preset.label}
            </button>
      ...
      <div style={{ marginBottom: 12 }}>
        <div style={{ color: '#9a99a8', marginBottom: 6 }}>Aspect ratio</div>
          ...
          {ASPECT_RATIOS.map((aspect) => (
            <button
              ...
              style={{
                ...
                background: canvasSize.aspectRatioId === aspect.id ? '#7c3aed' : '#1f1f28',
                border: '1px solid #2a2a34', color: '#fff',
              }}
            >
      ...
      <div style={{ marginBottom: 12 }}>
        <div style={{ color: '#9a99a8', marginBottom: 6 }}>Resolution</div>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
          {RESOLUTIONS.map((resolution) => {
            ...
            return (
              ...
              >
                ...
                {locked && <span style={{ color: '#9a99a8' }}>Pro</span>}
              </button>
            );
          })}
        </div>
      ...
      <div>
        <div style={{ color: '#9a99a8', marginBottom: 6 }}>Frame rate</div>
          ...
          {FPS_OPTIONS.map((fps) => (
            <button
              ...
              style={{
                ...
                background: canvasSize.fps === fps ? '#7c3aed' : '#1f1f28',
                border: '1px solid #2a2a34', color: '#fff',
              }}
            >
              {fps}
